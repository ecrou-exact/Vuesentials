 ...
 * @param {string} icon - The CSS class for the icon to be displayed in the toast (e.g., "fas fa-check").
 */
export async function create_message(message, toast_class, not_hide, icon) {
    ...
    // Attendre un peu plus pour s'assurer que le toast est rendu
    ...
    if (!toastLiveExample) {
        console.warn(`Toast element with id liveToast-${id} not found`);
        setTimeout(() => {
